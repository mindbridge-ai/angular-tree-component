...
export const TREE_ACTIONS = {
  ...
  SELECT: (tree: TreeModel, node: TreeNode, $event: any) => node.setIsSelected(true, false),
  DESELECT: (tree: TreeModel, node: TreeNode, $event: any) => node.setIsSelected(false, false),
