...
export declare class TreeNode implements ITreeNode {
    ...
    treeModel: TreeModel;
    private handler;
    private _someChildrenSelected;
    private _allChildrenSelected;
    private internalSelectState;
    ...
    _initChildren(): void;
    updatePendingChildStatus(status: boolean): void;
    /**
     ...
     */
    propogateStatusDownwards(): void;
    private emitSelectStatusChange;
    private updateChildrenSelectionStatus;
